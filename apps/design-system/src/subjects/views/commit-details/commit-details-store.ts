      ...
      blocks: [
        ...
        },
        {
          lines: [
            ...
            {
              content:
                "           'm-0 -mb-px h-11 border-b border-solid border-b-transparent px-0 text-xs font-normal text-foreground-2 duration-150 ease-in-out hover:text-cn-foreground-1 data-[state=active]:border-borders-9',",
              type: 'context',
              oldNumber: 31,
              newNumber: 31
            },
            ...
            {
              content:
                "-          'h-[36px] rounded-t-md border-x border-t border-transparent px-3.5 font-normal text-foreground-2 hover:text-cn-foreground-1 data-[state=active]:border-borders-1 data-[state=active]:text-cn-foreground-1 data-[state=active]:bg-background-1'",
              type: 'delete',
              oldNumber: 33
            },
            {
              content:
                "+          'h-[36px] rounded-t-md border-x border-t border-transparent px-3.5 font-normal text-foreground-2 hover:text-cn-foreground-1 data-[state=active]:border-borders-1 data-[state=active]:bg-background-1 data-[state=active]:text-cn-foreground-1'",
              type: 'insert',
              newNumber: 33
            },
            {
