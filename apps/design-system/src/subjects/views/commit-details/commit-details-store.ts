      ...
      blocks: [
        {
          lines: [
            {
              content: "       underline: 'h-11 justify-center gap-cn-md',",
              type: 'context',
              oldNumber: 11,
              newNumber: 11
            },
          ...
          oldStartLine2: null,
          newStartLine: 11,
          header: "@@ -11,7 +11,7 @@ const tabsListVariants = cva('inline-flex items-center text-cn-3', {"
        },
        {
          lines: [
            {
      ...
      blocks: [
        {
          lines: [
            ...
            {
              content: '-        <h1 className="text-cn-foreground-1 font-medium text-cn-size-6 flex gap-x-cn-xs">',
              type: 'delete',
              oldNumber: 53
            },
            {
              content: '+        <h1 className="flex gap-x-cn-xs text-cn-size-6 font-medium text-cn-foreground-1">',
              type: 'insert',
              newNumber: 53
            },
            {
            ...
            {
              content: '           <span className="font-normal text-cn-3">#{number}</span>',
              type: 'context',
              oldNumber: 55,
              newNumber: 55
            },
        ...
        },
        {
          lines: [
            ...
            {
              content: '           <span className="text-cn-3">{formattedTime}</span>',
              type: 'context',
              oldNumber: 86,
              newNumber: 86
            },
      ...
      blocks: [
        {
          lines: [
            ...
            {
              content: '-            <span className="text-cn-danger text-cn-size-1">{props.headerMsg}</span>',
              type: 'delete',
              oldNumber: 114
            },
            {
              content: '+            <span className="text-cn-size-1 text-cn-danger">{props.headerMsg}</span>',
              type: 'insert',
              newNumber: 114
            },
            {
        ...
        },
        {
          lines: [
            ...
            {
              content:
                '-                      <span className="text-cn-foreground-1 text-cn-size-1">Bypass and merge anyway</span>',
              type: 'delete',
              oldNumber: 234
            },
            {
              content:
                '+                      <span className="text-cn-size-1 text-cn-foreground-1">Bypass and merge anyway</span>',
              type: 'insert',
              newNumber: 234
            },
            {
      ...
      blocks: [
        {
          lines: [
            ...
            {
              content: '-  return <span className="text-cn-3 text-cn-size-1">{header}</span>',
              type: 'delete',
              oldNumber: 70
            },
            {
              content: '+  return <span className="text-cn-size-1 text-cn-3">{header}</span>',
              type: 'insert',
              newNumber: 70
            },
            {
        ...
        },
        {
          lines: [
            ...
            {
              content: '-                <div className="flex gap-x-cn-xs items-center">',
              type: 'delete',
              oldNumber: 247
            },
            {
              content: '+                <div className="flex items-center gap-x-cn-xs">',
              type: 'insert',
              newNumber: 247
            },
            {
            ...
            {
              content: '                   <span className="text-cn-size-2 text-cn-foreground-1">',
              type: 'context',
              oldNumber: 249,
              newNumber: 249
            },
        ...
        },
        {
          lines: [
            ...
            {
              content:
                "                   <span className=\"text-cn-size-2 text-cn-foreground-1\">{`Latest changes were approved by ${latestApprovalArr?.length || minReqLatestApproval || ''} ${easyPluralize(latestApprovalArr?.length || minReqLatestApproval, 'reviewer', 'reviewers')}`}</span>",
              type: 'context',
              oldNumber: 274,
              newNumber: 274
            },
      ...
      blocks: [
        {
          lines: [
            ...
            {
              content: '-      <h3 className="font-medium text-cn-size-2">{props.text}</h3>',
              type: 'delete',
              oldNumber: 14
            },
            {
              content: '+      <h3 className="text-cn-size-2 font-medium">{props.text}</h3>',
              type: 'insert',
              newNumber: 14
            },
            {
        ...
        },
        {
          lines: [
            ...
            {
              content: '     <div className="ml-cn-xl inline-flex items-center gap-cn-xs">',
              type: 'context',
              oldNumber: 21,
              newNumber: 21
            },
            {
              content: '-      <p className="text-cn-3 text-cn-size-2 font-normal">{props.text}</p>',
              type: 'delete',
              oldNumber: 22
            },
            {
              content: '+      <p className="text-cn-size-2 font-normal text-cn-3">{props.text}</p>',
              type: 'insert',
              newNumber: 22
            },
            {
      ...
      blocks: [
        {
          lines: [
            ...
            {
              content: '-                <p className="text-cn-3 text-cn-size-2 font-normal">',
              type: 'delete',
              oldNumber: 52
            },
            {
              content: '+                <p className="text-cn-size-2 font-normal text-cn-3">',
              type: 'insert',
              newNumber: 52
            },
            {
        ...
        },
        {
          lines: [
            ...
            {
              content:
                '-                  <div className="py-cn-2xs flex items-center gap-x-cn-xs" key={`${file}-${idx}`}>',
              type: 'delete',
              oldNumber: 87
            },
            {
              content:
                '+                  <div className="flex items-center gap-x-cn-xs py-cn-2xs" key={`${file}-${idx}`}>',
              type: 'insert',
              newNumber: 87
            },
            {
            ...
            {
              content: '                     <span className="text-cn-size-2 text-cn-foreground-1">{file}</span>',
              type: 'context',
              oldNumber: 89,
              newNumber: 89
            },
