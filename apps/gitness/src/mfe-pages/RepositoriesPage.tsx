...
import { ComponentProvider, PortalProvider, RouterContextProvider, TranslationProvider } from '@harnessio/ui/context'
...
interface RepositoriesPageProps extends MFEContextProps {
  on401?: () => void
...
export default function RepositoriesPage({
  ...
  return (
    <div ref={shadowRef} id="code-mfe-repositories">
      <ShadowRootWrapper>
                            ...
                            <ExitConfirmProvider>
                              <NavigationProvider routes={[]}>
                                <ComponentProvider components={{ RbacButton, RbacSplitButton }}>
                                  <RouterContextProvider navigate={customUtils.navigate} >
                                    <ReposListPage />
