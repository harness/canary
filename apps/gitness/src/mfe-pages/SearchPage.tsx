...
import SearchPageComponent from '../pages-v2/search-page'

interface SearchPageProps extends MFEContextProps {
  on401?: () => void
...
export default function SearchPage({
  ...
  return (
    <div ref={shadowRef} id="code-mfe-search">
      <ShadowRootWrapper>
  ...
  return (
    <>
      <div className="loading-container">
        <p className="loading-text">Loading search...</p>
      </div>
      <style>
        {`
      @keyframes blink {
