  ...
  return (
    <SearchPageView
      ...
      toRepoFileDetails={({ repoPath, filePath, branch }) =>
        repoPath && branch
          ? `/repos/${repoPath}/files/refs/heads/${branch}/~/${filePath}?keyword=${encodeURIComponent(searchQuery)}`
          : // TODO: get default branch
            `/repos/${repoRef}/files/refs/heads/main/~/${filePath}?keyword=${encodeURIComponent(searchQuery)}`
      }
