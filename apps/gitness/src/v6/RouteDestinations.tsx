...
import { AppShell, AppShellMFE } from '../components-v2/app-shell.tsx'
import { ProjectDropdown } from '../components-v2/breadcrumbs/project-dropdown.tsx'
import { AppProvider } from '../framework/context/AppContext.tsx'
import { ExplorerPathsProvider } from '../framework/context/ExplorerPathsContext.tsx'
import { CustomRouteObject, RouteConstants } from '../framework/routing/types.ts'
import { useTranslationStore } from '../i18n/stores/i18n-store.ts'
import { CreateProject } from '../pages-v2/create-project.tsx'
import { LandingPage } from '../pages-v2/landing-page-container.tsx'
import { Logout } from '../pages-v2/logout.tsx'
import PipelineEditPage from '../pages-v2/pipeline/pipeline-edit/pipeline-edit.tsx'
import ProjectPipelineListPage from '../pages-v2/pipeline/project-pipeline-list-page.tsx'
import { SettingsProfileGeneralPage } from '../pages-v2/profile-settings/profile-settings-general-container.tsx'
import { SettingsProfileKeysPage } from '../pages-v2/profile-settings/profile-settings-keys-container.tsx'
import { ProfileSettingsThemePage } from '../pages-v2/profile-settings/profile-settings-theme-page.tsx'
import { ProjectLabelFormContainer } from '../pages-v2/project/labels/project-label-form-container.tsx'
import { ProjectLabelsList } from '../pages-v2/project/labels/project-labels-list-container.tsx'
import { ProjectGeneralSettingsPageContainer } from '../pages-v2/project/project-general-settings-container.tsx'
import { ImportProjectContainer } from '../pages-v2/project/project-import-container.tsx'
import { ProjectMemberListPage } from '../pages-v2/project/project-member-list.tsx'
import { ProjectSettingsLayout } from '../pages-v2/project/project-settings-layout.tsx'
import PullRequestChanges from '../pages-v2/pull-request/pull-request-changes.tsx'
import { PullRequestCommitPage } from '../pages-v2/pull-request/pull-request-commits.tsx'
import { CreatePullRequest } from '../pages-v2/pull-request/pull-request-compare.tsx'
import PullRequestConversationPage from '../pages-v2/pull-request/pull-request-conversation.tsx'
import PullRequestDataProvider from '../pages-v2/pull-request/pull-request-data-provider.tsx'
import PullRequestLayout from '../pages-v2/pull-request/pull-request-layout.tsx'
import PullRequestListPage from '../pages-v2/pull-request/pull-request-list.tsx'
import { RepoLabelFormContainer } from '../pages-v2/repo/labels/label-form-container.tsx'
import { RepoLabelsList } from '../pages-v2/repo/labels/labels-list-container.tsx'
import { RepoBranchesListPage } from '../pages-v2/repo/repo-branch-list.tsx'
import { RepoBranchSettingsRulesPageContainer } from '../pages-v2/repo/repo-branch-rules-container.tsx'
import { RepoCode } from '../pages-v2/repo/repo-code.tsx'
import { CommitDiffContainer } from '../pages-v2/repo/repo-commit-details-diff.tsx'
import RepoCommitDetailsPage from '../pages-v2/repo/repo-commit-details.tsx'
import RepoCommitsPage from '../pages-v2/repo/repo-commits.tsx'
import { CreateRepo } from '../pages-v2/repo/repo-create-page.tsx'
import RepoExecutionListPage from '../pages-v2/repo/repo-execution-list.tsx'
import { ImportMultipleRepos } from '../pages-v2/repo/repo-import-multiple-container.tsx'
import { ImportRepo } from '../pages-v2/repo/repo-import-page.tsx'
import RepoLayout from '../pages-v2/repo/repo-layout.tsx'
import ReposListPage from '../pages-v2/repo/repo-list.tsx'
import RepoPipelineListPage from '../pages-v2/repo/repo-pipeline-list.tsx'
import { RepoSettingsGeneralPageContainer } from '../pages-v2/repo/repo-settings-general-container.tsx'
import { RepoSidebar } from '../pages-v2/repo/repo-sidebar.tsx'
import RepoSummaryPage from '../pages-v2/repo/repo-summary.tsx'
import { RepoTagsListContainer } from '../pages-v2/repo/repo-tags-list-container.tsx'
import { SignIn } from '../pages-v2/signin.tsx'
import { SignUp } from '../pages-v2/signup.tsx'
import { UserManagementPageContainer } from '../pages-v2/user-management/user-management-container.tsx'
import { CreateWebhookContainer } from '../pages-v2/webhooks/create-webhook-container.tsx'
import { WebhookExecutionDetailsContainer } from '../pages-v2/webhooks/webhook-execution-details-container.tsx'
import { WebhookExecutionsContainer } from '../pages-v2/webhooks/webhook-executions.tsx'
import WebhookListPage from '../pages-v2/webhooks/webhook-list.tsx'
