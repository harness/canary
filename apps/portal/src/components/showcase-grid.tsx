...
const ShowcaseGrid: FC = () => {
  ...
  const [taskCards, setTaskCards] = useState<CardData[]>([
    {
      id: "task-1",
      title: <Text variant="body-strong">Review quarterly reports</Text>,
      description: (
    ...
    {
      id: "task-2",
      title: <Text variant="body-strong">Update team documentation</Text>,
      description: (
        <Text variant="caption-normal" className="text-cn-muted">
          In progress
        </Text>
    ...
    {
      id: "task-3",
      title: <Text variant="body-strong">Schedule client meeting</Text>,
      description: (
        <Text variant="caption-normal" className="text-cn-muted">
          High priority
        </Text>
    ...
    {
      id: "task-4",
      title: <Text variant="body-strong">Prepare presentation slides</Text>,
      description: (
        <Text variant="caption-normal" className="text-cn-muted">
          For next Monday
        </Text>
          ...
          <div className="flex flex-col gap-cn-lg">
            ...
            <div className="flex items-center justify-between gap-cn-md">
              ...
              <div className="flex items-center gap-cn-sm">
                <Button variant="ghost" size="sm" iconOnly aria-label="Decrease GPU count" ignoreIconOnlyTooltip>
                  <IconV2 name="minus" size="xs" />
                </Button>
                <Text variant="body-normal">8</Text>
                <Button variant="ghost" size="sm" iconOnly aria-label="Increase GPU count" ignoreIconOnlyTooltip>
              ...
              <div className="flex items-center gap-cn-sm">
                ...
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    <Button variant="outline" size="sm" iconOnly aria-label="Open more options" ignoreIconOnlyTooltip>
...
### Next Steps
Contact Sarah Chen for budget approval by Friday.
  ...
  isDarkMode: true
        ...
        >
          ...
          <div className="flex flex-col gap-cn-lg">
            ...
            <div className="flex flex-col gap-cn-sm">
              <Text variant="caption-strong">Task Priority</Text>
              <Text variant="caption-normal" className="text-cn-muted mb-cn-xs">
                Drag to reorder tasks by priority
              </Text>
              <DraggableCardList cards={taskCards} setCards={setTaskCards} />
            </div>
          </div>
        </Card.Root>
        ...
        >
          ...
          <div className="flex flex-col gap-cn-lg">
            <div className="flex flex-col gap-cn-sm">
              <Text variant="caption-strong">Recent Activity</Text>
              <div className="flex flex-col gap-cn-xs">
                <div className="flex items-center justify-between p-cn-sm border border-cn-3 rounded-cn-2">
                  <div className="flex flex-col gap-cn-3xs">
                    <Text variant="body-strong">Sarah Chen commented</Text>
                ...
                <div className="flex items-center justify-between p-cn-sm border border-cn-3 rounded-cn-2">
                  <div className="flex flex-col gap-cn-3xs">
                    ...
                    <div className="flex items-center gap-cn-xs">
                      ...
                      <TimeAgoCard timestamp={Date.now() - 30 * 60 * 1000} />
                    </div>
                  </div>
                  <IconV2 name="nav-arrow-right" size="xs" />
                </div>
                ...
                <div className="flex items-center justify-between p-cn-sm border border-cn-3 rounded-cn-2">
                  <div className="flex flex-col gap-cn-3xs">
                    <Text variant="body-strong">Alex Rodriguez joined</Text>
                    <div className="flex items-center gap-cn-xs">
                      <Text variant="caption-normal" className="text-cn-muted">
                        Joined
                      </Text>
            ...
            <div className="flex flex-col gap-cn-sm">
              <Text variant="caption-strong">Share Links</Text>
              <div className="flex flex-col gap-cn-xs">
                <div className="flex items-center justify-between p-cn-sm border border-cn-3 rounded-cn-2">
                  <div className="flex flex-col gap-cn-3xs flex-1 min-w-0">
                    <Text variant="caption-normal" className="text-cn-muted">
                      Profile Link
                    </Text>
                    <Text variant="body-normal" className="truncate">
                      https://example.com/profile/sarah-chen
                    </Text>
                  </div>
                  <CopyButton name="https://example.com/profile/sarah-chen" />
                </div>
                ...
                <div className="flex items-center justify-between p-cn-sm border border-cn-3 rounded-cn-2">
                  <div className="flex flex-col gap-cn-3xs flex-1 min-w-0">
                    ...
                    <Text variant="body-normal" className="font-mono truncate">
                      INVITE2024XYZ
                    </Text>
                  </div>
                  <CopyButton name="INVITE2024XYZ" />
                </div>
                ...
                <div className="flex items-center justify-between p-cn-sm border border-cn-3 rounded-cn-2">
                  ...
                  <CopyButton name="sarah.chen@example.com" />
                </div>
              </div>
            </div>

            <div className="flex flex-col gap-cn-sm">
              <Text variant="caption-strong">Document Details</Text>
              <div className="p-cn-sm border border-cn-3 rounded-cn-2">
                <div className="flex items-center justify-between mb-cn-xs">
                  <Text variant="caption-normal" className="text-cn-muted">
                    Document ID
                  </Text>
                  <CopyButton name="DOC-2024-001" size="xs" />
                </div>
                <Text variant="body-normal" className="font-mono">
                  DOC-2024-001
                </Text>
                <div className="flex items-center gap-cn-xs mt-cn-xs">
                  <Text variant="caption-normal" className="text-cn-muted">
                    Last updated
                  </Text>
                  <TimeAgoCard
