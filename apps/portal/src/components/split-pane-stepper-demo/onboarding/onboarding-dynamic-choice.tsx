...
import { Button, Layout, Text, IconV2, Skeleton } from "@harnessio/ui/components";
...
export function DynamicChoice({
  ...
  return (
    <Layout.Vertical gap="md">
            ...
            {items.map((item) => (
              ...
              >
                <span className="min-w-0 flex-1 overflow-hidden text-left">
                  <Text truncate variant="body-normal" color="foreground-1" className="block min-w-0 w-full">
                    {item.name}
                  </Text>
                </span>
              </Button>
      ...
      <Button variant="outline" size="md" className="w-full justify-center" onClick={handleRefresh} disabled={loading}>
        {loading ? (
