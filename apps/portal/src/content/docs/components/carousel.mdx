...
<DocsPage.ComponentExample
  ...
  code={`<div className="flex items-center justify-center">
    <Carousel.Root className="w-1/2">
      ...
      <Carousel.Content>
        <Carousel.Item>
          <div className="h-64 w-full bg-blue-800 text-cn-1 flex items-center justify-center">Slide 1</div>
        </Carousel.Item>
        <Carousel.Item>
          <div className="h-64 w-full bg-green-800 text-cn-1 flex items-center justify-center">Slide 2</div>
        </Carousel.Item>
        <Carousel.Item>
          <div className="h-64 w-full bg-red-800 text-cn-1 flex items-center justify-center">Slide 3</div>
        </Carousel.Item>
      </Carousel.Content>
      <Carousel.Next />
    </Carousel.Root>
