...
<DocsPage.ComponentExample
  ...
  <PromptInput.Toolbar>
    <PromptInput.Tools>
      <PromptInput.Button text="Add attachment" prefixIcon="plus" prefixIconProps={{ size: 'sm' }} tooltipProps={{ title: 'Add' }} />
    </PromptInput.Tools>
    <PromptInput.Submit />
  </PromptInput.Toolbar>
</PromptInput.Root>
...
return (
  <PromptInput.Root onSubmit={handleSubmit}>
    ...
    <PromptInput.Toolbar>
      <PromptInput.Tools>
        <PromptInput.Button text="Add attachment" prefixIcon="plus" tooltipProps={{ title: 'Add' }} />
      </PromptInput.Tools>
      <PromptInput.Submit />
    </PromptInput.Toolbar>
  </PromptInput.Root>
