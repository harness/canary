...
<DocsPage.ComponentExample
  ...
  <PromptInput.Disclaimer>
    Harness AI can make mistakes. Please double check responses.
  </PromptInput.Disclaimer>
</div>`}
/>
...
- **PromptInput.Disclaimer** - Optional disclaimer text displayed below the toolbar
