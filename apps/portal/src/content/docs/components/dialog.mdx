...
<DocsPage.PropsTable
  props={[
    {
      name: "children",
      description: "You can pass in your `Dialog.Trigger` and `Dialog.Content` as children",
      required: true,
      value: "ReactNode",
    },
    {
    ...
    {
      name: "onOpenChange",
      description: "Callback that fires when the open state of the dialog changes",
      required: false,
