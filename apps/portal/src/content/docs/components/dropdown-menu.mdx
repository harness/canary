...
<DocsPage.ComponentExample
  ...
  code={`<DropdownMenu.Root>
    ...
    <DropdownMenu.Content>
        <DropdownMenu.IconItem icon="pr-closed" title="With icon" />
        <DropdownMenu.IconItem icon="pr-open" title="With icon and description" description="Item description" />
...
<DropdownMenu.Item
  ...
  prefix={<Icon />}         // [OPTIONAL] prefix element (icon, avatar, etc.)
  className="my-class"      // [OPTIONAL] custom class
