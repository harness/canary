  ...
  code={`<DropdownMenu.Root>
    ...
    <DropdownMenu.Content className="flex">
        <ScrollArea>
          ...
          <DropdownMenu.Group label="Pre-built group">


              <DropdownMenu.IndicatorItem color="pink" title="With indicator" />
              <DropdownMenu.IndicatorItem color="cyan" title="With icon and description" description="Item description" />
          </DropdownMenu.Group>
  ...
  code={`<DropdownMenu.Root>
    ...
    <DropdownMenu.Content>
        <DropdownMenu.Group label="Checkbox group">
            <DropdownMenu.CheckboxItem title="Default" />
            <DropdownMenu.CheckboxItem title="Checked" checked />
            <DropdownMenu.CheckboxItem title="Disabled" disabled />
            <DropdownMenu.CheckboxItem title="Checked disabled" description="Item description" checked disabled  />
            <DropdownMenu.CheckboxItem title="With submenu" checked="indeterminate">
              <DropdownMenu.CheckboxItem title="Sub Option 1" />
              <DropdownMenu.CheckboxItem title="Sub Option 2" checked />
          </DropdownMenu.CheckboxItem>
        </DropdownMenu.Group>
...
<DocsPage.ComponentExample
  ...
  code={`<DropdownMenu.Root>
    ...
    <DropdownMenu.Content>
        <DropdownMenu.RadioGroup label="Group 2" value="option5">
            ...
            <DropdownMenu.RadioItem value="option6" title="Checked disabled" description="Item description" disabled />
        </DropdownMenu.RadioGroup>
