...
<Aside type="tip" title="When to use CounterBadge">
  Use `CounterBadge` for a numeric count attached to something — failing checks on a
  build, pending approvals, unread items. For the *state* of a thing (success, failed,
  running), use `StatusBadge`. For a descriptive label, use `Tag`.
</Aside>
...
<DocsPage.ComponentExample
  ...
  code={`<div className="flex flex-col gap-cn-md">
    <div className="flex gap-cn-sm">
      <Text variant="heading-subsection" as="h4" className="min-w-[80px]">Outline:</Text>
      <div className="flex gap-cn-sm">
    ...
    <div className="flex gap-cn-sm">
      <Text variant="heading-subsection" as="h4" className="min-w-[80px]">Secondary:</Text>
      <div className="flex gap-cn-sm">
