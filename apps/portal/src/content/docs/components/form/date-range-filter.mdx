...
<Aside type="tip" title="When to use DateRangeFilter">
  Use `DateRangeFilter` to filter a list or chart by a date window — runs in the last 7
  days, deploys this month. For picking a date as a form value, use `Calendar`.
</Aside>
