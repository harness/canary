...
<DocsPage.PropsTable
  props={[
    ...
    },
    {
      ...
      description: "Custom preset date ranges. If not provided, a default set of presets is used (Last 7 Days, This Month, Last 30 Days, etc.).",
      required: false,
      value: "DateRangePreset[]",
    },
    {
      name: "filterFieldConfig.showCustomRange",
      description: "Whether to show the 'Select custom range' option. When clicked, a two-month calendar appears alongside the preset list.",
      required: false,
      defaultValue: "true",
      value: "boolean",
    },
...
<DocsPage.PropsTable
  props={[
    ...
    {
      name: "preset",
      description: "The preset key if a preset was selected, undefined for custom ranges.",
      required: false,
      value: "string",
    },
  ]}
