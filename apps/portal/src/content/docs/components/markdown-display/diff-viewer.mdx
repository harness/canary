...
- **Light Theme** - Uses light syntax highlighting and UI colors
- **Dark Theme** - Uses dark syntax highlighting and UI colors

The theme switches automatically when your application theme changes.
