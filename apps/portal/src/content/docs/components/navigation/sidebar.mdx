...
<Aside>
  In the unified app shell, nav backgrounds are owned by the column shell (
  <code>cn-nav-surface-bg</code>), not individual sidebar panels — inner{" "}
  <code>Sidebar</code> surfaces stay transparent. See{" "}
  <a href="/foundations/app-shell">App Shell</a> for the full surface layer
  model.
</Aside>
...
<LinkCard
  ...
  description="Background IA, utility classes, and nav rail transparency rules"
/>
