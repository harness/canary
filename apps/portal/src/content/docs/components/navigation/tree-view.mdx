...
return <Tree className="h-64 w-full rounded-3 border">
...
return (
  <Tree initialSelectedId="1-1" className="h-96 w-full rounded-3 border">
    <Folder
      element="Documents"
      value="folder-1"
...
return <Tree className="h-80 w-full rounded-3 border">
...
return <Tree initialSelectedId="target-file" className="h-64 w-full rounded-3 border">
...
className="h-64 w-full rounded-3 border"
...
<Tree className="h-80 w-full rounded-3 border" elements={collapseTreeElements}>
...
return <Tree dir="rtl" className="h-64 w-full rounded-3 border">
...
<Tree
  ...
  className="h-[600px] w-full rounded-3 border"
>
  <Folder
...
<Tree className="h-96 w-full rounded-3 border">
