        ...
        <Drawer.Content size="md">
          <Tabs.Root value={tab} onValueChange={setTab}>
            <Drawer.HeaderV2
              ...
              icon="pipeline"
              tabs={[
                { label: 'Overview', value: 'overview', badge: { variant: 'primary', theme: 'info', content: 'New' } },
...
<DocsPage.PropsTable
  props={[
    ...
    },
    {
      name: "tabs",
      description:
        "Array of tab items rendered as an underlined tab strip at the bottom of the header. See HeaderV2TabItem below.",
      required: false,
