...
The tooltip supports `default` and `subtle` themes. The default theme provides high-contrast appearance and is used by default. The subtle theme provides a lighter, standard appearance.
  ...
  code={`
    <TooltipProvider>
      <ButtonLayout className="justify-center">
        ...
        >
          <Button variant="secondary">Default Theme (default)</Button>
        </Tooltip>

        <Tooltip
          theme="subtle"
          content="Standard tooltip styling"
        >
          <Button variant="secondary">Subtle Theme</Button>
        </Tooltip>
      </ButtonLayout>
    </TooltipProvider>
