...
The tooltip supports `subtle` and `default` themes. The subtle theme provides standard appearance, while the default theme provides high-contrast appearance.
  ...
  code={`
    <TooltipProvider>
      <ButtonLayout className="justify-center">
        ...
        >
          <Button variant="secondary">Subtle Theme (default)</Button>
        </Tooltip>
