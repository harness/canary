...
<DocsPage.ComponentExample
  ...
  code={`() => {
    ...
    return (
        <div className="flex flex-col w-[600px] gap-40">
            <div>
                <h5>Determinate Pagination (renders Button)</h5>
                <Pagination
                    totalItems={100}
                    pageSize={10}
            ...
            <hr />
            <div>
                <h5>Determinate Pagination with truncateLimit (renders Button) </h5>
                <Pagination
                    totalItems={100}
                    pageSize={10}
                    truncateLimit={7}
            ...
            <hr />
            <div>
                <h5>Determinate Pagination with page numbers hidden (renders Button)</h5>
                <Pagination
                    totalItems={100}
                    pageSize={10}
                    currentPage={currentPage}
            ...
            <div>
                <h5>Determinate Pagination with getPageLink (renders Link)</h5>
                <Pagination
                    totalItems={100}
                    pageSize={10}
                    currentPage={currentPage}
            ...
            <div>
                <h5>Indeterminate Pagination with getPrevPageLink and getNextPageLink</h5>
                <h5>(renders Link)</h5>
                <Pagination
                    indeterminate
            ...
            <div>
                <h5>Indeterminate Pagination with onNext and onPrevious (renders Button)</h5>
                <Pagination
                    indeterminate
                    hasNext={currentPage < 100}
                    hasPrevious={currentPage > 1}
