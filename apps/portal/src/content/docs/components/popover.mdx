...
Popovers are great for containing forms or interactive content.
            ...
            >
                <div className="grid gap-3">
                    <div className="grid gap-2">
                        <Text size="sm" color="foreground-2">Name</Text>
                        <Input
                            type="text"
                            value={name}
                    ...
                    <div className="grid gap-2">
                        <Text size="sm" color="foreground-2">Email</Text>
                        <Input
                            type="email"
                            value={email}
...
Popovers can contain complex layouts and multiple interactive elements.
...
<DocsPage.ComponentExample
  ...
  code={`<Popover.Root>
    ...
    >
        <div className="grid gap-3">
            <div className="flex gap-3 p-3 rounded-md bg-gray-50">
                <IconV2 name="check-circle" className="text-green-500 mt-0.5" />
                <div className="grid gap-1">
                    <Text size="sm" weight="medium">Build completed successfully</Text>
                    <Text size="sm" color="foreground-2">Your deployment is now live</Text>
                    <Text size="xs" color="foreground-3">2 minutes ago</Text>
                </div>
            </div>

            <div className="flex gap-3 p-3 rounded-md bg-gray-50">
                <IconV2 name="alert-triangle" className="text-yellow-500 mt-0.5" />
                <div className="grid gap-1">
                    <Text size="sm" weight="medium">Warning: High memory usage</Text>
                    <Text size="sm" color="foreground-2">Consider upgrading your plan</Text>
                    <Text size="xs" color="foreground-3">5 minutes ago</Text>
                </div>
            </div>

            <div className="flex gap-3 p-3 rounded-md bg-gray-50">
                <IconV2 name="user-plus" className="text-blue-500 mt-0.5" />
                <div className="grid gap-1">
                    <Text size="sm" weight="medium">New team member joined</Text>
                    <Text size="sm" color="foreground-2">Sarah Connor has been added to your team</Text>
                    <Text size="xs" color="foreground-3">10 minutes ago</Text>
                </div>
            </div>
        </div>
    </Popover.Content>
