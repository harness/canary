...
Enable client-side search filtering to help users find options quickly in large lists.
    ...
    return (
      <div className="grid gap-4">
        ...
        <SelectV2
          ...
          allowSearch
          onSearch={(query) => {
            // Custom search that includes email addresses
...
Use the `optionRenderer` prop to customize how options are displayed in the dropdown.
...
<DocsPage.ComponentExample
  ...
  code={`() => {
    ...
    const userOptions = [
      { label: 'John Doe', value: 'john', role: 'Admin', avatar: '/avatar1.png' },
      { label: 'Jane Smith', value: 'jane', role: 'Developer', avatar: '/avatar2.png' },
      { label: 'Bob Johnson', value: 'bob', role: 'Designer', avatar: '/avatar3.png' },
    ]
          ...
          optionRenderer={(option) => (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-cn-foreground-3">{option.role}</div>
              </div>
            </div>
          )}
      ...
      { 
        label: (
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-cn-foreground-3">default</span>
          </div>
        ), 
        value: 'main' 
      },
...
<DocsPage.PropsTable
  props={[
    {
      name: "options",
      description: "Array of options or async function that returns options",
      required: true,
      value: "SelectOption<T>[] | () => Promise<SelectV2Option<T>[]>",
    },
    {
      name: "value",
    ...
    },
    {
      ...
      required: false,
      value: "(option: SelectOption<T>) => React.ReactElement",
...
<Aside title="Tip">
  Use the `DropdownMenu` component directly if you need more advanced
  customization of the dropdown behavior beyond what the `optionRenderer` prop
  provides.
</Aside>
