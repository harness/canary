    ...
    return (
      <div className="grid gap-4">
        ...
        <Select
          ...
          placeholder="Select a fruit"
          allowSearch
          header={<Text className="mt-2">Select a fruit</Text>}
          footer={<Text>Footer content here</Text>}
        />
      </div>
    );
...
<Select
  ...
  optionRenderer={renderer} // [OPTIONAL] custom option
  triggerRenderer={triggerRenderer} // [OPTIONAL] custom trigger renderer
  dropdownAlign             // [OPTIONAL] dropdown alignment
...
<DocsPage.PropsTable
  props={[
    ...
    },
    {
      name: "dropdownAlign",
      description:
        "Defines the alignment of the dropdown relative to the trigger.",
      required: false,
      value: "'start' | 'end'",
      defaultValue: "'start'",
    },
    {
      name: "triggerRenderer",
      description: "Custom renderer for the trigger button.",
      required: false,
      value: "(selectedLabel: ReactNode) => ReactNode",
    },
  ]}
/>
