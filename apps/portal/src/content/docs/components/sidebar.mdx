                  ...
                  <Sidebar.MenuItem>
                    <Sidebar.MenuButton>
                      <Sidebar.MenuItemText
                        className="pl-0"
                        text='Repositories'
                        icon={<IconV2 name="repositoy" size="sm" />}
                      />
                    </Sidebar.MenuButton>
                  </Sidebar.MenuItem>
                  <Sidebar.MenuItem>
                    <Sidebar.MenuButton>
                      <Sidebar.MenuItemText
                        className="pl-0"
                        text='Pipelines'
                        icon={<IconV2 name="pipeline" size="sm" />}
                      />
                    </Sidebar.MenuButton>
                  </Sidebar.MenuItem>
                  <Sidebar.MenuItem>
                    <Sidebar.MenuButton>
                      <Sidebar.MenuItemText
                        className="pl-0"
                        text='More'
                        icon={<IconV2 name="menu-more-horizontal" size="sm" />}
                      />
                    </Sidebar.MenuButton>
                  </Sidebar.MenuItem>
                </Sidebar.Menu>
                  ...
                  <Sidebar.MenuItem>
                    <Sidebar.MenuButton>
                      <Sidebar.MenuItemText
                        ...
                        icon={<IconV2 name="service-accounts" size="sm" />}
                      />
                    </Sidebar.MenuButton>
                  </Sidebar.MenuItem>
                </Sidebar.Menu>
