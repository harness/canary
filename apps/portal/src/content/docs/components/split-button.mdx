...
<DocsPage.ComponentExample
  ...
  {/* Variants and Themes */}
  <div>
    <Text variant="heading-subsection" as="h4" className="mb-3">Variants and Themes</Text>
    
    {/* Primary Variant */}
    <div className="mb-6">
      <Text variant="heading-small" as="h5" color="foreground-3" className="mb-3">Primary Variant</Text>
    ...
    {/* Secondary Variant */}
    <div className="mb-6">
      <Text variant="heading-small" as="h5" color="foreground-3" className="mb-3">Secondary Variant</Text>
      <div className="flex flex-wrap items-end gap-4">
        <SplitButton
    ...
    {/* Outline Variant */}
    <div className="mb-6">
      <Text variant="heading-small" as="h5" color="foreground-3" className="mb-3">Outline Variant</Text>
      <div className="flex flex-wrap items-end gap-4">
        <SplitButton
          id="outline-default"
          variant="outline"
...
{/* Disabled States */}
  ...
  <div>
    <Text variant="heading-subsection" as="h4" className="mb-3">Disabled State</Text>
    <div className="flex flex-wrap items-end gap-4">
      <SplitButton
        id="disabled-state"
        handleButtonClick={() => {}}
