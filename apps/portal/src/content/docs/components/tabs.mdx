...
<DocsPage.ComponentExample
  ...
  code={`<Tabs.Root className="grid gap-3" defaultValue="inbox">
    <Tabs.List>
        ...
        <Tabs.Trigger value="spam" counter={null}>
            Spam
        </Tabs.Trigger>
    </Tabs.List>
...
Tab triggers can combine icons/logos with counters for richer information display.

<DocsPage.ComponentExample
  client:only
  code={`<Tabs.Root className="grid gap-3" defaultValue="issues">
    <Tabs.List>
        <Tabs.Trigger value="issues" icon="github-circle-solid" counter={12}>
            Issues
        </Tabs.Trigger>
        <Tabs.Trigger value="pull-requests" icon="git-pull-request" counter={5}>
            Pull Requests
        </Tabs.Trigger>
        <Tabs.Trigger value="actions" icon="github-action" counter={0}>
            Actions
        </Tabs.Trigger>
        <Tabs.Trigger value="projects" icon="folder" counter={2}>
            Projects
        </Tabs.Trigger>
    </Tabs.List>
    
    <Tabs.Content value="issues">
        <Text>12 open issues</Text>
    </Tabs.Content>
    <Tabs.Content value="pull-requests">
        <Text>5 open pull requests</Text>
    </Tabs.Content>
    <Tabs.Content value="actions">
        <Text>No running actions</Text>
    </Tabs.Content>
    <Tabs.Content value="projects">
        <Text>2 active projects</Text>
    </Tabs.Content>
</Tabs.Root>`}
/>
  ...
  code={`<Tabs.Root className="grid gap-3" defaultValue="custom1">
    <Tabs.List>
        ...
        <Tabs.Trigger value="custom2">
            <IconV2 name="folder" />
            <span>Documents</span>
            <Text size="sm" color="disabled">(2.3 GB)</Text>
        </Tabs.Trigger>
    </Tabs.List>
