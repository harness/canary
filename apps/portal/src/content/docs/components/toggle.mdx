...
<DocsPage.ComponentExample
  ...
  <div className="flex gap-20">
    <div className="grid gap-4 justify-items-center">
      <Text>variant:</Text>
      <Toggle text="outline" />
      <Toggle text="ghost" variant="ghost" />
      <Toggle text="transparent" variant="transparent" />
    </div>
    <div className="grid gap-4 justify-items-center">
      <Text>selected variant:</Text>
      <Toggle text="primary (selected)" selectedVariant="primary" selected />
      <Toggle text="secondary (selected)" selectedVariant="secondary" selected />
    </div>
  </div>
`}
/>
