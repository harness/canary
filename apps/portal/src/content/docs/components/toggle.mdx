...
<DocsPage.PropsTable
  props={[
    ...
    {
      name: "text",
      description: "The text content of the toggle and its accessibility label.",
      required: false,
      value: "string",
    },
    {
    ...
    {
      name: "prefixIcon",
      description: "An optional icon to display before the text. When iconOnly is true, this will be the only icon displayed.",
      required: false,
      value: "string",
    },
    {
