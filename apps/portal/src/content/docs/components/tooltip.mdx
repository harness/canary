  ...
  code={`<Tooltip.Provider>
    <Tooltip.Root open>
        ...
        <Tooltip.Content className="p-3">
            <Text>You are not authorized to create / edit Connectors.</Text>
            <br />
            <Text className="text-cn-foreground-2">You are missing the following permission: <br />
"Create / Edit Connectors" in Account scope</Text>
						<Tooltip.Arrow className="filter TooltipArrow" />
        </Tooltip.Content>
    </Tooltip.Root>
</Tooltip.Provider>`}
/>
