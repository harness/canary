...
<Button className="bg-cn-brand-primary text-white">Click me</Button>
```
...
<button className="bg-cn-brand-primary p-cn-md rounded-cn-3">Click me</button>
```
...
```tsx
<div className="bg-cn-1 text-cn-2">{/* Light background, dark text */}</div>
```
