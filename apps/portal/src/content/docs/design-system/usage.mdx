...
<div className="not-content">
  <LinkCard
    ...
    title="Shadows"
    description="Elevation levels and app shell rail shadows"
  />
</div>

### App shell surfaces

Persistent nav, chat, and content regions use dedicated surface utility class names (`cn-app-shell-bg`, `cn-nav-surface-bg`, etc.) — defined in platformUI, backed by `comp.app-shell.*` tokens — not raw `bg-cn-*` on shell layers.

<div className="not-content">
  <LinkCard
    href="/foundations/app-shell"
    title="App Shell"
    description="Background IA and surface class reference"
  />
</div>
