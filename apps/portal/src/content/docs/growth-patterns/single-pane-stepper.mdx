...
<DocsPage.PropsTable
  props={[
    ...
    },
    {
      ...
      description:
        "Grouped-mode only: omit groups whose derived state is upcoming. Visited and active groups still render. No-op on flat flows. Visual only — engine derivation, routing, and badge totals are unchanged.",
      required: false,
      value: "boolean",
      defaultValue: "false",
    },
    {
      ...
      description:
        "Omit predicted nested-step placeholders in grouped mode, and upcoming entries from the flat timeline. Visual only — engine derivation, routing, badge totals, and the indeterminate placeholder still follow the engine.",
      required: false,
      value: "boolean",
      defaultValue: "false",
    },
    ...
    {
      name: "className",
      description: "Merged onto the SinglePane root layout element",
      required: false,
      value: "string",
    },
    {
      name: "style",
      description: "Inline style on the SinglePane root layout element",
      required: false,
      value: "CSSProperties",
    },
  ]}
