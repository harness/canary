 ...
 * Generated on Fri, 14 Mar 2025 10:48:36 GMT
 * Copyright (c) Harness.
 */
...
export default {
  ...
  border: {
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-850) l c h / 0.7)",
      $description:
  ...
  ring: {
    focus: {
      $type: "shadow",
      $value:
        "0 0 0 2px lch(3.66% 1.93 285.7), 0 0 0 4px lch(56.15% 39.92 238.95)",
      $description:
