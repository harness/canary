 ...
 * Generated on Fri, 14 Mar 2025 15:14:42 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    dropdown: {
      ...
      item: {
        title: {
          ...
          name: "canary-component-dropdown-item-title",
          attributes: {
            category: "component",
            type: "dropdown",
            item: "item",
        ...
        description: {
          ...
          name: "canary-component-dropdown-item-description",
          attributes: {
            category: "component",
            type: "dropdown",
            item: "item",
    ...
    tooltip: {
      ...
      border: {
        ...
        name: "canary-component-tooltip-border",
        attributes: {
          category: "component",
          type: "tooltip",
          item: "border",
