...
export default {
  ...
  border: {
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-800) l c h / 0.7)",
      $description:
    ...
    alert: {
      ...
      danger: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-red-300) l c h / 0.2)",
          $description:
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-300) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-500) l c h / 0.1)",
          $description:
      ...
      danger: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-red-300) l c h / 0.6)",
          $description:
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-yellow-300) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-yellow-500) l c h / 0.1)",
          $description:
      ...
      running: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-300) l c h / 0.6)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-purple-300) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-purple-500) l c h / 0.1)",
          $description:
      ...
      ai: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-pure-white) l c h / 0.05)",
          $description:
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(90.23% 26.34 77.18) 0%, lch(72% 46.72 350.11) 35%, lch(61.28% 80.51 307.53) 65%, lch(74.15% 38.44 238.45) 100%)",
          $description:
    ...
    pipeline: {
      ...
      card: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "radial-gradient(604% 142% at 0% 0%, lch(74.82% 51.93 49.87) 0%, lch(from var(--canary-colors-chrome-800) l c h / 0.4) 30%, lch(74.82% 51.93 49.87) 100%)",
            $description:
      ...
      background: {
        dotes: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-chrome-850) l c h / 0.6)",
          $description:
  ...
  shadow: {
    0: {
      $type: "shadow",
      $value: "0 0 0 0 lch(from var(--canary-colors-pure-black) l c h / 0)",
      $description:
    ...
    1: {
      $type: "shadow",
      $value:
        "0 1px 2px 0 lch(from var(--canary-colors-pure-black) l c h / 0.6)",
      $description:
    ...
    2: {
      $type: "shadow",
      $value:
        "0 1px 3px 0 lch(from var(--canary-colors-pure-black) l c h / 0.6), 0 1px 2px -1px lch(from var(--canary-colors-pure-black) l c h / 0.6)",
      $description:
    ...
    3: {
      $type: "shadow",
      $value:
        "0 4px 6px -1px lch(from var(--canary-colors-pure-black) l c h / 0.5), 0 2px 4px -2px lch(from var(--canary-colors-pure-black) l c h / 0.5)",
      $description:
    ...
    4: {
      $type: "shadow",
      $value:
        "0 10px 15px -3px lch(from var(--canary-colors-pure-black) l c h / 0.5), 0 4px 6px -4px lch(from var(--canary-colors-pure-black) l c h / 0.5)",
      $description:
    ...
    5: {
      $type: "shadow",
      $value:
        "0 20px 25px -5px lch(from var(--canary-colors-pure-black) l c h / 0.5), 0 8px 10px -6px lch(from var(--canary-colors-pure-black) l c h / 0.5)",
      $description:
    ...
    6: {
      $type: "shadow",
      $value:
        "0 25px 50px -12px lch(from var(--canary-colors-pure-black) l c h / 0.6)",
      $description:
    ...
    inner: {
      $type: "shadow",
      $value:
        "inset 0 2px 4px 0 lch(from var(--canary-colors-pure-white) l c h / 0.1)",
      $description:
  ...
  "shadow-color": {
    0: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-pure-black) l c h / 0)",
      $description:
    ...
    1: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-pure-black) l c h / 0.6)",
      $description:
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-pure-black) l c h / 0.5)",
      $description:
    ...
    pipeline: {
      running: {
        ...
        "gradient-stop-2": {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-chrome-800) l c h / 0.4)",
          filePath: "design-tokens/mode/dark/high-contrast.json",
          isSource: true,
          original: {
            $extensions: {
