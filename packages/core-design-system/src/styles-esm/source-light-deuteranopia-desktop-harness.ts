 ...
 * Generated on Fri, 14 Mar 2025 14:28:31 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-500) l c h / 0.1)",
          $description:
    ...
    badge: {
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(61.26% 69.37 350) 35%, lch(65.49% 45.28 239) 65%, lch(74.15% 38.44 238.45) 100%)",
          $description:
    ...
    btn: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-300) l c h / 0.12)",
          $description:
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-orange-300) l c h / 0.15)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-orange-300) l c h / 0.25)",
            $description:
    ...
    diff: {
      ...
      "del-content": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-orange-500) l c h / 0.12)",
        $description:
      ...
      "del-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-orange-500) l c h / 0.2)",
        $description:
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-orange-500) l c h / 0.25)",
        $description:
