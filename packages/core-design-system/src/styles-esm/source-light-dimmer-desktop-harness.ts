 ...
 * Generated on Fri, 14 Mar 2025 14:28:29 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-200) l c h / 0.07)",
          $description:
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-yellow-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-yellow-200) l c h / 0.07)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-purple-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-purple-300) l c h / 0.07)",
          $description:
    ...
    btn: {
      ...
      success: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-200) l c h / 0.08)",
          $description:
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-green-500) l c h / 0.08)",
        $description:
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-green-500) l c h / 0.15)",
        $description:
