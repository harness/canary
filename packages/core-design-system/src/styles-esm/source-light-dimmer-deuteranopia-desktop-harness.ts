  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-500) l c h / 0.08)",
          $description:
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-400) l c h / 0.15)",
          $description:
    ...
    btn: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-300) l c h / 0.08)",
          $description:
    ...
    diff: {
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-orange-500) l c h / 0.15)",
        $description:
