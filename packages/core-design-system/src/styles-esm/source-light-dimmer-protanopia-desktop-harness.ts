  ...
  component: {
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-200) l c h / 0.07)",
          $description:
    ...
    btn: {
      ...
      success: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-200) l c h / 0.08)",
          $description:
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-blue-200) l c h / 0.1)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-blue-200) l c h / 0.15)",
            $description:
    ...
    diff: {
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-blue-500) l c h / 0.15)",
        $description:
