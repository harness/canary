 ...
 * Generated on Fri, 14 Mar 2025 10:48:48 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-400) l c h / 0.1)",
          $description:
    ...
    badge: {
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(54.81% 69.74 52.27) 35%, lch(56.15% 39.92 238.95) 65%, lch(65.49% 45.28 239) 100%)",
          $description:
    ...
    diff: {
      ...
      "del-content": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-orange-400) l c h / 0.12)",
        $description:
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-orange-400) l c h / 0.25)",
        $description:
