 ...
 * Generated on Fri, 14 Mar 2025 14:28:30 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-400) l c h / 0.2)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-300) l c h / 0.1)",
          $description:
    ...
    btn: {
      ...
      success: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-300) l c h / 0.12)",
          $description:
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-blue-400) l c h / 0.25)",
          $description:
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-blue-300) l c h / 0.15)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-blue-300) l c h / 0.25)",
            $description:
    ...
    diff: {
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-blue-500) l c h / 0.25)",
        $description:
