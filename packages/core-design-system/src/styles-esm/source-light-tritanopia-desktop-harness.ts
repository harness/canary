 ...
 * Generated on Fri, 14 Mar 2025 14:28:33 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-cyan-400) l c h / 0.2)",
          $description:
      ...
      warning: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-200) l c h / 0.1)",
          $description:
      ...
      merged: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-cyan-300) l c h / 0.1)",
          $description:
    ...
    btn: {
      ...
      success: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-cyan-200) l c h / 0.12)",
          $description:
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-cyan-400) l c h / 0.25)",
          $description:
        ...
        state: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-cyan-200) l c h / 0.25)",
            $description:
    ...
    diff: {
      ...
      "add-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-cyan-500) l c h / 0.2)",
        $description:
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-cyan-500) l c h / 0.25)",
        $description:
