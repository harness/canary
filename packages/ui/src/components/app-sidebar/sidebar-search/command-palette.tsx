...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex h-full w-full flex-col overflow-hidden rounded-[10px] bg-cn-background-2 text-popover-foreground',
      className
    )}
    {...props}
  />
