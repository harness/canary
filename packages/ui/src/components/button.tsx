  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded text-14 font-medium transition-colors disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-cn-borders-2 bg-transparent text-foreground-2 hover:border-cn-borders-6 hover:text-foreground-8',
        ...
        'gradient-border': 'bg-cn-background-2 text-foreground-1 hover:bg-cn-background-8',
        custom: ''
      },
      size: {
        default: 'h-8 px-6',
      ...
      theme: {
        ...
        primary: 'border-primary-foreground/20 bg-cn-background-5 text-foreground-6',
        disabled:
