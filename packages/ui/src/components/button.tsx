...
const buttonVariants = cva(
  'button inline-flex items-center justify-center whitespace-nowrap transition-colors disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        // default:
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    return (
      <Comp
        className={cn(buttonVariants({ variant, size, theme, borderRadius, rounded, className }))}
        ref={ref}
        disabled={disabled || loading}
        {...props}
      >
