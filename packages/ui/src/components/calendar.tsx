  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-cn-background-accent text-cn-brand hover:bg-cn-background-accent hover:text-cn-brand focus:bg-cn-background-accent focus:text-cn-brand',
        day_today: 'bg-cn-background-3 text-cn-1',
        day_outside:
          'day-outside text-cn-3 opacity-50  aria-selected:bg-cn-background-3/50 aria-selected:text-cn-3 aria-selected:opacity-30',
        day_disabled: 'text-cn-3 opacity-50',
        day_range_middle: 'aria-selected:bg-cn-background-3 aria-selected:text-cn-1',
