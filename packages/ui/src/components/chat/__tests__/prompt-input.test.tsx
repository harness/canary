...
const composerStyles = promptInputStyles['.cn-prompt-input'] as {
  ...
  '.cn-control-group': CSSProperties & { minHeight: number | string; overflow: string; flex: string }
  '.cn-control-group-input': CSSProperties & { minHeight: number | string; overflow: string }
