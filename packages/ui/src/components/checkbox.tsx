  ...
  ({ className, ...props }, ref) => (
    <div className={cn('flex gap-x-2.5', className)}>
      <CheckboxPrimitive.Root
        ref={ref}
        className="peer flex size-4 shrink-0 items-center justify-center rounded-sm border border-icons-1 hover:border-icons-3 disabled:cursor-not-allowed disabled:border-icons-4 data-[state=checked]:border-icons-2 data-[state=checked]:bg-cn-background-1 data-[state=checked]:text-cn-foreground-1"
        {...props}
      >
