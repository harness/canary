...
export const DrawerContent = forwardRef<ElementRef<typeof DrawerPrimitive.Content>, DrawerContentProps>(
  (
    ...
    const { direction, isParentOpen, modal } = useDrawerContext()
    ...
    return (
      <DrawerPrimitive.Portal container={portalContainer}>
        <DrawerOverlay style={drawerCoordinates} className={overlayClassName} />
        {withCustomOverlay && (
          <DrawerPrimitive.Close asChild>
            <div
              className={cn('cn-drawer-backdrop', overlayClassName)}
              style={drawerCoordinates}
              data-vaul-overlay
