  ...
  return (
    <DropdownMenuPortal container={portalContainer}>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'bg-cds-background-2 text-foreground-8 shadow-1 z-50 min-w-[8rem] overflow-hidden !rounded border border-borders-2 p-1',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'data-[highlighted]:bg-cds-background-4 data-[highlighted]:text-primary data-[highlighted]:outline-none',
