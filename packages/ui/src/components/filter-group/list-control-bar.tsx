...
import { FilterField as FiltersField, FiltersFieldProps, FilterOptionConfig, renderFilterSelectAddIconLabel } from '../filters'
...
export function ListControlBar<T extends Record<string, any>, CustomValue = Record<string, unknown>, V = T[keyof T]>({
  filterOptions,
  selectedFiltersCnt,
  openedFilter,
  sortSelectionsCnt,
