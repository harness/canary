        ...
        <div className="ml-2.5 flex w-full items-center justify-between gap-x-4">
          <div className="flex items-center gap-x-4">
            <FilterTrigger
              type="filter"
              customLabel={
                <div className="flex items-center gap-x-1.5 text-cn-foreground-4 transition-colors duration-200 hover:text-cn-foreground-1">
            ...
            />
            <button
              className="flex items-center gap-x-1.5 text-14 text-cn-foreground-4 outline-none ring-offset-2 ring-offset-background transition-colors duration-200 hover:text-cn-foreground-danger focus:ring-2"
