...
import ArrowDownRightCircle from './icons/arrow-down-right-circle.svg'
import ArrowDownRight from './icons/arrow-down-right.svg'
import ArrowDown from './icons/arrow-down.svg'
import ArrowEmailForward from './icons/arrow-email-forward.svg'
import ArrowLeftCircle from './icons/arrow-left-circle.svg'
import ArrowLeft from './icons/arrow-left.svg'
import ArrowLongDown from './icons/arrow-long-down.svg'
import ArrowLongLeft from './icons/arrow-long-left.svg'
import ArrowLongRight from './icons/arrow-long-right.svg'
import ArrowLongUp from './icons/arrow-long-up.svg'
import ArrowRightCircle from './icons/arrow-right-circle.svg'
import ArrowRight from './icons/arrow-right.svg'
import ArrowUpCircle from './icons/arrow-up-circle.svg'
import ArrowUpLeftCircle from './icons/arrow-up-left-circle.svg'
...
import BubbleIncome from './icons/bubble-income.svg'
import BubbleOutcome from './icons/bubble-outcome.svg'
import BubbleSearch from './icons/bubble-search.svg'
...
import ChatBubbleTranslate from './icons/chat-bubble-translate.svg'
import ChatBubbleWarning from './icons/chat-bubble-warning.svg'
import ChatBubbleXmark from './icons/chat-bubble-xmark.svg'
...
import DatabaseStats from './icons/database-stats.svg'
import DatabaseTag from './icons/database-tag.svg'
...
import DownloadDataWindow from './icons/download-data-window.svg'
...
import GitCompare from './icons/git-compare.svg'
import GitFork from './icons/git-fork.svg'
import GitMerge from './icons/git-merge.svg'
import GitPullRequestClosed from './icons/git-pull-request-closed.svg'
import GitPullRequestDraft from './icons/git-pull-request-draft.svg'
...
import MultiBubble from './icons/multi-bubble.svg'
import MultiplePagesEmpty from './icons/multiple-pages-empty.svg'
...
import RedoCircle from './icons/redo-circle.svg'
import Redo from './icons/redo.svg'
import Reduce from './icons/reduce.svg'
import RefreshCircleSolid from './icons/refresh-circle-solid.svg'
...
import StarPlus from './icons/star-plus.svg'
...
import TreeView from './icons/tree-view.svg'
import UnderlineSquare from './icons/underline-square.svg'
import Underline from './icons/underline.svg'
import UndoAction from './icons/undo-action.svg'
...
export const IconNameMapV2 = {
  ...
  'arrow-email-forward': ArrowEmailForward,
  ...
  'bubble-income': BubbleIncome,
  'bubble-outcome': BubbleOutcome,
  'bubble-search': BubbleSearch,
  ...
  'chat-bubble-xmark': ChatBubbleXmark,
  ...
  'download-data-window': DownloadDataWindow,
  download: Download,
  ...
  'more-vert': MoreVert,
  'multi-bubble': MultiBubble,
  'multiple-pages-empty': MultiplePagesEmpty,
  ...
  'redo-circle': RedoCircle,
  redo: Redo,
  reduce: Reduce,
  'refresh-circle-solid': RefreshCircleSolid,
