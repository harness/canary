...
import { BaseInputsProp, Button, ControlGroup, FormCaption, IconV2, Label } from '@/components'

import { BaseInput, InputProps } from './base-input'

export interface NumberInputProps extends BaseInputsProp, Omit<InputProps, 'type'> {
  hideStepper?: boolean
  integerOnly?: boolean
}
