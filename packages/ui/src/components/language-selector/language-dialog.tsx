          ...
          {supportedLanguages.map(lang => (
            ...
            >
              <div className="flex items-center gap-2">
                <div className="flex size-6 items-center justify-center rounded bg-cds-background-12 text-12 uppercase text-foreground-3">
                  {lang.code}
                </div>
                <span
                  className={cn(
              ...
              <span
                className={cn(
                  'absolute -inset-x-2 -inset-y-1 rounded group-hover:bg-cds-background-4',
                  selectedLanguage === lang.code && 'bg-cds-background-4'
                )}
                aria-hidden
              />
            </button>
