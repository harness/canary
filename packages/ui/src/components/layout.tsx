...
const gapVariants = cva('', {
  variants: {
    ...
    gapX: {
      none: 'gap-x-0',
      '4xs': 'gap-x-layout-4xs',
      '3xs': 'gap-x-layout-3xs',
      '2xs': 'gap-x-layout-2xs',
      xs: 'gap-x-layout-xs',
      sm: 'gap-x-layout-sm',
      md: 'gap-x-layout-md',
      lg: 'gap-x-layout-lg',
      xl: 'gap-x-layout-xl',
      '2xl': 'gap-x-layout-2xl',
      '3xl': 'gap-x-layout-3xl',
      '4xl': 'gap-x-layout-4xl'
    },
    gapY: {
      none: 'gap-y-0',
      '4xs': 'gap-y-layout-4xs',
      '3xs': 'gap-y-layout-3xs',
      '2xs': 'gap-y-layout-2xs',
      xs: 'gap-y-layout-xs',
      sm: 'gap-y-layout-sm',
      md: 'gap-y-layout-md',
      lg: 'gap-y-layout-lg',
      xl: 'gap-y-layout-xl',
      '2xl': 'gap-y-layout-2xl',
      '3xl': 'gap-y-layout-3xl',
      '4xl': 'gap-y-layout-4xl'
    }
  }
})
