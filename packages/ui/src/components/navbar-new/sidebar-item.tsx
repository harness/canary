      ...
      <DropdownMenu.Root>
        <Sidebar.MenuAction>
          <DropdownMenu.Trigger asChild>
            <Button
              className="absolute right-[-0.8125rem] -top-1 text-icons-4 opacity-0 hover:text-icons-2 focus:opacity-100 focus-visible:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100"
              size="sm_icon"
              variant="custom"
            >
