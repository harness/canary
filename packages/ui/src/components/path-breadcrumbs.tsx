...
const InputPathBreadcrumbItem = ({
  ...
  return (
    <div className="flex items-center gap-1.5 text-cn-foreground-4">
      <Input
        className="w-[200px]"
        id="fileName"
        value={fileName}
      ...
      />
      <span>in</span>
      <span className="flex h-6 items-center gap-1 rounded bg-cn-background-8 px-2.5 text-cn-foreground-8">
