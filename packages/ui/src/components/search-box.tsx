    ...
    return (
      <div className={cn('relative', width === 'full' ? 'w-full' : 'w-96', className)}>
        ...
        {hasShortcut && !!shortcutLetter && (
          <div
            className={cn(
              'absolute right-1.5 top-1/2 flex h-5 -translate-y-1/2 cursor-pointer items-center gap-0.5 rounded-sm border bg-cn-background-3 px-1 text-foreground-2 duration-100 ease-in-out',
              {
