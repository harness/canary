  ...
  ({ id, disabled, label, caption, error, optional, className, resizable = false, ...props }, ref) => {
    return (
      <ControlGroup>
        ...
        <textarea
          className={cn(
            'placeholder:text-cn-foreground-2 flex min-h-[74px] w-full rounded border bg-cn-background-2 px-3 py-2 text-sm focus-visible:outline-none focus-visible:rounded disabled:cursor-not-allowed',
