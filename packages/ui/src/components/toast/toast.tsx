...
const toastVariants = cva(
  'pointer-events-auto relative flex h-12 w-full items-center justify-between overflow-hidden rounded border py-2 pl-3.5 pr-2 shadow-lg transition-all',
  {
    variants: {
      variant: {
        default: 'border-cn-2 bg-cn-background-3',
        destructive: 'bg-cn-foreground-danger border-transparent',
        success: 'border-cn-2 bg-cn-background-3',
        failed: 'border-cn-2 bg-cn-background-3'
      }
    },
    defaultVariants: {
      variant: 'default'
