...
const toastVariants = cva(
  'pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded border py-3 pl-3.5 pr-12 shadow-lg transition-all',
  {
    variants: {
      variant: {
        default: 'border-cn-borders-2 bg-cn-background-3 text-foreground [&_svg]:text-icons-1',
        destructive: 'border-cn-borders-danger bg-foreground-danger text-foreground-1 [&_svg]:text-icons-2',
        success:
