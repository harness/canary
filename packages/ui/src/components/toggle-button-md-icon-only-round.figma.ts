// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-20784
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ icon selected#9451:189') : null
const selectedIcon =
...
export default {
  ...
  id: 'toggle-button-md-icon-only-round',
  metadata: {
    nestable: true
  }
}
