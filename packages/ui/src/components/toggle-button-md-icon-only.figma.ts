// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-20693
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ selected icon#9447:82') : null
const selectedIcon =
