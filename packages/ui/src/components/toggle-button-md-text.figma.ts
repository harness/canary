// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-19823
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ selected icon#9447:0') : null
const selectedIcon =
  selectedIconInstance && selectedIconInstance.type === 'INSTANCE'
    ? extractIconName(selectedIconInstance.executeTemplate())
    : null

const selectedSuffixIconInstance = selected ? instance.getInstanceSwap('↳ selected suffix icon#9447:41') : null
