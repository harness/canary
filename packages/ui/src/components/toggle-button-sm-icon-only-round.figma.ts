// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-21039
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ selected icon#9477:99') : null
const selectedIcon =
...
export default {
  ...
  id: 'toggle-button-sm-icon-only-round',
  metadata: {
    nestable: true
  }
}
