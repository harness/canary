// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-20435
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ selected icon#9477:0') : null
const selectedIcon =
  selectedIconInstance && selectedIconInstance.type === 'INSTANCE'
    ? extractIconName(selectedIconInstance.executeTemplate())
    : null

const selectedSuffixIconInstance = selected ? instance.getInstanceSwap('↳ selected suffix icon#9477:33') : null
...
export default {
  ...
  id: 'toggle-button-sm-text-rounded',
  metadata: {
    nestable: true
  }
}
