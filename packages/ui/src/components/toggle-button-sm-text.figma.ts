// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-19984
...
const label = instance.getString('buttonString#37:10')
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ selected icon#9451:222') : null
const selectedIcon =
  selectedIconInstance && selectedIconInstance.type === 'INSTANCE'
    ? extractIconName(selectedIconInstance.executeTemplate())
    : null

const selectedSuffixIconInstance = selected ? instance.getInstanceSwap('↳ selected suffix icon#9451:255') : null
