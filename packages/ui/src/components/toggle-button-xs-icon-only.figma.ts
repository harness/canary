// url=https://www.figma.com/design/AIgjIyUzcuZzuVnuoOyhQE/HDS-%7C-Components-3.0?node-id=28553-20948
...
const selectedIconInstance = selected ? instance.getInstanceSwap('↳ selected icon#9477:198') : null
const selectedIcon =
