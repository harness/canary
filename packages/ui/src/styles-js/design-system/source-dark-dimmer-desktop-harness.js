...
export default {
    ...
    badge: {
      ...
      neutral: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-chrome-300) l c h / 0.2)",
          $description:
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-300) l c h / 0.2)",
          $description:
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-yellow-300) l c h / 0.2)",
          $description:
      ...
      running: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-300) l c h / 0.2)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-purple-300) l c h / 0.2)",
          $description:
  ...
  ring: {
    focus: {
      $type: "shadow",
      $value:
        "0 0 0 2px lch(2.44% 1.49 285.81), 0 0 0 4px lch(37.53% 29.54 238.95)",
      $description:
