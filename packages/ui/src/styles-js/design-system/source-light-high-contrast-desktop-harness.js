 ...
 * Generated on Wed, 12 Mar 2025 09:22:04 GMT
 * Copyright (c) Harness.
 */
...
export default {
  ...
  border: {
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-200) l c h / 0.7)",
      $description:
  ...
  state: {
    hover: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-300) l c h / 0.15)",
      $description:
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-red-400) l c h / 0.1)",
          $description:
    ...
    badge: {
      ...
      neutral: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-chrome-600) l c h / 0.6)",
          $description:
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-400) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-green-300) l c h / 0.1)",
          $description:
      ...
      danger: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-red-400) l c h / 0.6)",
          $description:
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-yellow-400) l c h / 0.6)",
          $description:
      ...
      running: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-orange-400) l c h / 0.6)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--canary-colors-purple-400) l c h / 0.6)",
          $description:
      ...
      success: {
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-green-300) l c h / 0.15)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--canary-colors-green-300) l c h / 0.25)",
            $description:
    ...
    dialog: {
      ...
      backdrop: {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-chrome-500) l c h / 0.5)",
        $description:
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-green-400) l c h / 0.12)",
        $description:
      ...
      "del-content": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-red-400) l c h / 0.12)",
        $description:
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-red-400) l c h / 0.25)",
        $description:
      ...
      "hunk-content": {
        ...
        $type: "color",
        $value: "lch(from var(--canary-colors-blue-400) l c h / 0.12)",
        $description:
      ...
      card: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "radial-gradient(604% 142% at 0% 0%, lch(54.81% 69.74 52.27) 0%, lch(from var(--canary-colors-chrome-300) l c h / 0.4) 30%, lch(54.81% 69.74 52.27) 100%)",
            $description:
  ...
  shadow: {
    0: {
      $type: "shadow",
      $value: "0 0 0 0 lch(from var(--canary-colors-chrome-950) l c h / 0)",
      $description:
    ...
    1: {
      $type: "shadow",
      $value:
        "0 1px 2px 0 lch(from var(--canary-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    2: {
      $type: "shadow",
      $value:
        "0 1px 3px 0 lch(from var(--canary-colors-chrome-950) l c h / 0.6), 0 1px 2px -1px lch(from var(--canary-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    3: {
      $type: "shadow",
      $value:
        "0 4px 6px -1px lch(from var(--canary-colors-chrome-950) l c h / 0.5), 0 2px 4px -2px lch(from var(--canary-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    4: {
      $type: "shadow",
      $value:
        "0 10px 15px -3px lch(from var(--canary-colors-chrome-950) l c h / 0.5), 0 4px 6px -4px lch(from var(--canary-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    5: {
      $type: "shadow",
      $value:
        "0 20px 25px -5px lch(from var(--canary-colors-chrome-950) l c h / 0.5), 0 8px 10px -6px lch(from var(--canary-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    6: {
      $type: "shadow",
      $value:
        "0 25px 50px -12px lch(from var(--canary-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    inner: {
      $type: "shadow",
      $value:
        "inset 0 2px 4px 0 lch(from var(--canary-colors-chrome-950) l c h / 0.1)",
      $description:
  ...
  "shadow-color": {
    0: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-950) l c h / 0)",
      $description:
    ...
    1: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    inner: {
      ...
      $type: "color",
      $value: "lch(from var(--canary-colors-chrome-950) l c h / 0.1)",
      $description:
