...
/**
 * Adopt connector form definition to be used in connector details view
 */
export function adoptConnectorFormDefinitionToView(formDefinition: IFormDefinition) {
  ...
  // NOTE: this works if we use accordion in all connector forms
