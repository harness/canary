...
import { githubConnectorFormDefinition, GITHUB_CONNECTOR_DESCRIPTION } from "./harness-connectors/github-connector"
import { TERRAFORM_CONNECTOR_DESCRIPTION, terraformConnectorFormDefinition } from "./harness-connectors/terraform-connector"
import { AWS_KMS_CONNECTOR_IDENTIFIER, GITHUB_CONNECTOR_IDENTIFIER, HarnessConnectorDefinitionType, TERRAFORM_CONNECTOR_IDENTIFIER } from "./types"
...
export function getHarnessConnectorDefinition(
  identifier: string
): HarnessConnectorDefinitionType | undefined {
