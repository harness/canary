    ...
    <Floating1ColumnLayout className={cn(className, 'relative max-w-full overflow-hidden')}>
      {hasGradients && (
        <div className="pointer-events-none absolute inset-0 z-0" aria-hidden>
          <span
            className={cn(
              'absolute blur-[30px] top-0 left-1/2 -translate-y-1/2 w-[528px] h-[178px] rounded-cn-full opacity-10 mix-blend-plus-lighter',
          ...
          <span
            className={cn(
              'absolute blur-[30px] top-[14px] -translate-y-1/2 left-1/2 w-[895px] h-[377px] rounded-cn-full opacity-[0.14]',
          ...
          <span
            className={cn(
              'absolute blur-[30px] bottom-0 translate-y-1/2 left-1/2 w-[895px] h-[261px] rounded-cn-full opacity-[0.08]',
              '[mask-image:radial-gradient(50%_50%_at_50%_50%,#000_0%,transparent_100%)]',
              'transition-[transform,background-color] ease-in-out duration-700',
