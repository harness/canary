...
const inputReferenceVariants = cva(
  'flex h-9 min-h-9 cursor-pointer items-center justify-between rounded bg-cn-background-3 px-3 py-2 text-foreground-1 transition-colors',
  {
    variants: {
      state: {
        default: 'border border-cn-borders-2',
        disabled: 'cursor-not-allowed border border-cn-borders-1 bg-cn-background-3 text-foreground-7'
      }
    },
    defaultVariants: {
      state: 'default'
