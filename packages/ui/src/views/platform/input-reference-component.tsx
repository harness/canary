...
const inputReferenceVariants = cva(
  'bg-cn-background-3 text-foreground-1 flex h-9 min-h-9 cursor-pointer items-center justify-between rounded px-3 py-2 transition-colors',
  {
    variants: {
      state: {
        default: 'border-cn-borders-2 border',
        disabled: 'bg-cn-background-3 text-foreground-7 border-cn-borders-2 cursor-not-allowed border'
      }
    },
    defaultVariants: {
      state: 'default'
