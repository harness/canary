...
import { IconType, PullRequestType } from './types'
  ...
  return (
    <div className="flex items-center gap-4">
      <div
        ...
        onKeyDown={e => {
          if (e.key === 'Enter') setHeaderFilter('open')
        }}
      ...
      <div
        ...
        onKeyDown={e => {
          if (e.key === 'Enter') setHeaderFilter('closed')
        }}
        className={cx('flex items-center gap-2', {
      ...
      <div className="flex flex-wrap justify-start gap-2">
        ...
        {labels &&
          labels.map((l, l_idx) => {
            ...
            return (
              <Badge key={l_idx} variant="outline" size={'sm'} borderRadius="full" className={cx(border, text, bg)}>
