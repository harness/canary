        ...
        <Dialog.Body>
          <div className="flex flex-col gap-y-7">
            ...
            <TextInput
              ...
              readOnly
              suffix={<CopyButton buttonVariant="transparent" iconSize="sm" name={tokenData?.identifier} />}
            />
            ...
            <TextInput
              ...
              readOnly
              suffix={<CopyButton buttonVariant="transparent" iconSize="sm" name={tokenData?.token} />}
              autoFocus
            />
