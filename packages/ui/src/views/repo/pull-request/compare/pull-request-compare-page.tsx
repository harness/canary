              ...
              <TabsList className="relative left-1/2 w-[calc(100%+160px)] -translate-x-1/2 px-20">
                {!prBranchCombinationExists && (
                  <TabTriggerItem
                    value="overview"
                    icon="comments"
                    label={t('views:pullRequests.compareChangesTabOverview')}
                  />
                )}
                <TabTriggerItem
                  value="commits"
                  icon="tube-sign"
                  label={t('views:pullRequests.compareChangesTabCommit')}
                  badgeCount={diffStats.commits ? diffStats.commits : undefined}
                />
                <TabTriggerItem
                  value="changes"
                  icon="changes"
                  label={t('views:pullRequests.compareChangesTabChanges')}
