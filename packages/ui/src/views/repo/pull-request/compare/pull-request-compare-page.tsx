      ...
      <SandboxLayout.Content className="px-20">
        ...
        <Layout.Vertical className="mt-2.5">
          ...
          <Layout.Horizontal align="center" gap="xs">
            <IconV2 name="git-compare" size="sm" className="text-icons-1" />
                  ...
                  {mergeability ? (
                    ...
                    <>
                      {apiError === "head branch doesn't contain any new commits." ? (
                        <>
                          <IconV2 name="xmark" size="xs" className="text-icons-1" />
            ...
            <div className="flex items-center gap-x-1.5">
              <div>
                <Layout.Horizontal align="center">
                  <IconV2 name="git-compare" size="sm" className="text-icons-success" />
