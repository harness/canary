      ...
      <div className="flex items-center gap-x-3">
        ...
        <div className="inline-flex flex-wrap items-center gap-1 text-foreground-4">
          ...
          <Badge variant="tertiary" size="md" borderRadius="base">
            <Link className="flex items-center gap-x-1" to={`${spaceId ? `/${spaceId}` : ''}/repos/${repoId}/code/${target_branch}`}>
          ...
          <span>from</span>
          <Badge variant="tertiary" size="md" borderRadius="base">
            <Link className="flex items-center gap-x-1" to={`${spaceId ? `/${spaceId}` : ''}/repos/${repoId}/code/${source_branch}`}>
              <Icon name="branch" size={12} className="text-icons-9" />
              {source_branch}
            </Link>
          </Badge>
