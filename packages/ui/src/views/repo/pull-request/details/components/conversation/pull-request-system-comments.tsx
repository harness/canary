...
import PullRequestTimelineItem, { TimelineItemProps, TimelineItemPropsHeaderType } from './pull-request-timeline-item'
...
const PullRequestSystemComments: FC<SystemCommentProps> = ({
  ...
  const payloadMain = commentItems[0]?.payload

  if (!payloadMain) return <></>

  const { id, payload, type, author, metadata, mentions } = payloadMain
