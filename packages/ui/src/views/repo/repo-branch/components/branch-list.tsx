              ...
              >
                ...
                <Table.Cell className="content-center">
                  <div className="flex h-6 items-center">
                    <div className="inline-flex h-6 max-w-80 items-center truncate rounded bg-cn-background-8 px-2.5 text-14 text-foreground-8">
                ...
                <Table.Cell className="content-center">
                  <div className="flex items-center justify-center gap-1.5 align-middle">
                    {branch?.behindAhead?.default ? (
                      <Badge
                        className="m-auto rounded-full bg-cn-background-2 px-2 text-center font-medium text-foreground-3"
                        variant="outline"
                        size="sm"
                      >
                ...
                <Table.Cell className="max-w-20 content-center">
                  {branch.pullRequests && branch.pullRequests.length > 0 && branch.pullRequests[0].number && (
                    <Button
                      className="flex w-fit items-center gap-1 bg-cn-background-8 px-2.5 text-sm text-foreground-8 hover:bg-cn-background-9 hover:text-foreground-1"
                      variant="custom"
                      size="xs"
                      asChild
                    >
