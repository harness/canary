    ...
    <Layout.Grid className={cn('', className)} gapY="3xs">
      ...
      {behindAhead?.behind === 0 && behindAhead?.ahead == 0 ? null : (
        <Layout.Grid columns={2} align="center" justify="center" className="mx-auto w-20">
          <Progress
            className="[&_.cn-progress-root::-moz-progress-bar]:bg-cn-gray-secondary [&_.cn-progress-root::-webkit-progress-value]:bg-cn-gray-secondary rotate-180 justify-self-end [&_.cn-progress-root]:rounded-l-none"
          ...
          />
          <Progress
            className="[&_.cn-progress-root::-moz-progress-bar]:bg-cn-gray-primary [&_.cn-progress-root::-webkit-progress-value]:bg-cn-gray-primary [&_.cn-progress-root]:rounded-l-none"
