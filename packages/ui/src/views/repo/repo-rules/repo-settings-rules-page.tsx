...
import { EnumBypassListType, PatternsButtonType, RulesFormFields, rulesFormSchema } from './types'
import { areRulesValid, combineAndNormalizePrincipalsAndGroups } from '../utils'
import { RuleToggleField } from './components/repo-rules-fields'
  ...
  return (
    <Layout.Vertical className={cn('settings-form-width', { 'mx-auto': projectScope })} gapY="md">
      ...
      <FormWrapper {...formMethods} onSubmit={handleSubmit(onSubmit)}>
        <RuleToggleField type={} register={register} setValue={setValue} watch={watch} />
        <FormSeparator />
