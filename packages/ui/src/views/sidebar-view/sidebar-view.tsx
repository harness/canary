...
export const SidebarView = ({
  ...
  return (
    <>
      <Sidebar.Root className="!z-30" onClick={() => console.log('Sidebar clicked')}>
        <Sidebar.Header>
          <SearchProvider>
            <Layout.Grid gapY="md">
              <HarnessLogo />
        ...
        <Sidebar.Content>
          <Sidebar.Group>
            ...
            <Drawer.Root direction="left" noBodyStyles onOpenChange={handleMoreMenu} modal={false}>
          ...
          <Sidebar.Group>
            ...
            <Drawer.Root direction="left" noBodyStyles onOpenChange={handleSettingsMenu} modal={false}>
              <Drawer.Trigger asChild>
                <Sidebar.Item
