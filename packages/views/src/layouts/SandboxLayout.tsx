...
function Header({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <header className={cn('bg-cn-background fixed left-[220px] right-0 top-0 z-40 h-[55px]', className)} role="banner">
      {children}
    </header>
  )
}
...
function SubHeader({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <header
      className={cn('bg-cn-background fixed left-[220px] right-0 top-[55px] z-40 h-[45px]', className)}
      role="banner"
    >
      {children}
    </header>
