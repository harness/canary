...
var external = Object.keys(package_default.devDependencies || []).concat(Object.keys(package_default.peerDependencies || [])).concat(Object.keys(package_default.peerDependencies || [])).concat([
